...
<div class="hero"><h1>A/B Testing</h1>
<p class="subtitle">Fleet-wide experiment framework. Compare vessel variants, measure impact, ship winners with confidence.</p></div>
<div class="features"><div class="card"><h3>Experiment Creation</h3><p>Define variants, metrics, and sample sizes.</p></div>
<div class="card"><h3>Traffic Splitting</h3><p>Route users to different vessel variants.</p></div>
<div class="card"><h3>Statistical Significance</h3><p>Automated p-value and confidence calculation.</p></div>
<div class="card"><h3>Winner Selection</h3><p>Ship the winning variant automatically.</p></div>
</div>
<div class="endpoints"><h3 style="color:#f59e0b;margin-bottom:1rem">API Endpoints</h3><div class="ep">POST /api/experiment - Create experiment</div>
<div class="ep">GET /api/results - View results</div>
<div class="ep">POST /api/rollout - Roll out winner</div>
